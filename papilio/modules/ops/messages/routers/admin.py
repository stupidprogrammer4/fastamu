"""The back-office messaging API (AccessScope.MESSAGES): the message log, the
...
from papilio.modules.ops.messages.config.dependencies import MessageID
from papilio.modules.ops.messages.domain.dtos import (
    MessageSearch,
    SmsPatternUpsert,
    SmsProviderActivate,
    SmsProviderUpsert,
...
from papilio.modules.ops.messages.routers.schemas import (
    MessageOut,
    SmsPatternOut,
    SmsProviderOut,
)
...
router = APIRouter(
    ...
    dependencies=[Depends(require_access(AccessScope.MESSAGES))],
)
